...
# Learning parameters
checkpoint = "./saved_models/srresnetbs16/checkpoint_srresnet_93.pth.tar"  # path to model checkpoint, None if none
...
def main():
    ...
    for epoch in range(start_epoch, epochs):
        ...
        torch.save({'epoch': epoch,
                    'model': model,
                    'optimizer': optimizer},
                   './saved_models/srresnetbs16/checkpoint_srresnet_%d.pth.tar'%epoch)
